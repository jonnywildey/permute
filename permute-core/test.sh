...
RUST_BACKTRACE=full target/release/permute --file=examples/beep24.wav --files=examples/vibe.wav,examples/snare.wav --trimAll --output ./renders/ --inputTrail=0 --outputTrail=2  --permutations=4 --depth=1  --normalise --processorCount=1 --processor='Cross Distort'
