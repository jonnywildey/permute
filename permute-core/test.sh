...
RUST_BACKTRACE=full target/release/permute --file=examples/pads.wav --files=examples/beep24.wav --output ./renders/ --inputTrail=0 --permutations=1 --trimAll  --depth=2  --normalise --processorCount=1 --processor='Granular Stretch'
