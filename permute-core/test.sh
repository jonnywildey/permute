...
RUST_BACKTRACE=full target/release/permute --file=examples/pads.wav --files=examples/beep24.wav --output ./renders/ --inputTrail=0 --permutations=3 --depth=1  --normalise --processorCount=1 --processor='Blur Stretch'
