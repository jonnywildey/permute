...
const OutputFile = memo(
  ({ file, onDelete, onShow, onReverse, onTrim, onPlay }: OutputFileProps) => {
    ...
    return (
      <Box key={file.path} {...props}>
        ...
        >
          <Tooltip openDelay={OUTPUT_TOOLTIP_DELAY} label={file.name}>
            <Heading
              size="sm"
              width="80%"
              display="block"
          ...
          <Tooltip openDelay={OUTPUT_TOOLTIP_DELAY} label="Delete file">
            <IconButton
              aria-label="delete"
              variant="ghost"
              rounded="full"
        ...
        >
          <IconButton
            ...
            _hover={{ bg: "brand.50" }}
          />
          <Tooltip openDelay={OUTPUT_TOOLTIP_DELAY} label="Open directory">
            <IconButton
              aria-label="show"
              variant="ghost"
              rounded="full"
          ...
          <Tooltip openDelay={OUTPUT_TOOLTIP_DELAY} label="Reverse">
            <IconButton
              aria-label="show"
              variant="ghost"
              rounded="full"
          ...
          <Tooltip openDelay={OUTPUT_TOOLTIP_DELAY} label="Auto-trim">
            <IconButton
              aria-label="show"
              variant="ghost"
              rounded="full"
          ...
          <ProcessorSummary
            ...
            tooltipDelay={OUTPUT_TOOLTIP_DELAY}
          />
          <Text
            pr={2}
            width="100%"
...
export const Output = memo(
  ({
    ...
    const completeFiles = useMemo(
      () =>
        permutationOutputs.filter(
          (f) => f.progress === 100 && f.image && !f.deleted,
        ),
      [permutationOutputs],
    );
