import { Box, Heading, List, ListItem, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, Text } from "@chakra-ui/react";
...
export const Welcome: React.FC<WelcomeProps> = ({ isOpen, onClose }) => {
  ...
  <Text fontSize="lg" mb={2}>
    Permute utilises the power of <b>random permutations</b> to dramatically 
    alter audio to something alien, abstract, and possibly <b>useful</b>. 
   </Text>
   <Text fontSize="lg" mb={2}>
