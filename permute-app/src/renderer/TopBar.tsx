...
export const TopBar: React.FC = () => {
  return (
    <>
      <GridItem
        rowSpan={2} colSpan={3} bg='green.100' borderBottom="0.5px solid"
      ...
      <GridItem rowSpan={2} colSpan={9} bg='green.100' borderBottom="0.5px solid" borderBottomColor="green.200" />
    </>
  );
}