const pauseContent = <g fill="currentColor">
  <g>
...
export const PauseIcon = () => <svg version="1.1" className="chakra-icon" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
  width="9.5px" height="9.5px" viewBox="0 0 300.003 300.003"
>
  {pauseContent}
</svg>;

export const LargePauseIcon = () => <svg version="1.1" className="chakra-icon" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
  width="16px" height="16px" viewBox="0 0 300.003 300.003"
>
  {pauseContent}
</svg>;
